      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: "🤝", title: "Trust & Transparency", description: "We build trust through transparent operations and clear communication." },
              { icon: "💡", title: "Innovation First", description: "We continuously innovate to solve logistics challenges." },
              { icon: "🌟", title: "Customer Focus", description: "Our users' success is our success. We put them first." },
              { icon: "🌍", title: "Local Impact", description: "We're committed to Ethiopia's economic growth." },
              { icon: "⚡", title: "Efficiency", description: "We optimize every aspect of the logistics process." },
              { icon: "🤲", title: "Community", description: "We build a strong community of drivers and freight owners." },
            ].map((value, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
